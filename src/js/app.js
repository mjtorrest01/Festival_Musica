...
function crearGaleria(){
    ...
    for(let i = 1; i <= 12; i++ ) {
        ...
        imagen.innerHTML = `
            ...
            <img loading="lazy" width="200" height="300" src="build/img/thumb/${i}.jpg" alt="imagen Galeriathumb/">
        `;
...
function mostrarImagen(id) {
    const imagen = document.createElement('picture');
        imagen.innerHTML = `
            ...
            <img loading="lazy" width="200" height="300" src="build/img/grande/${id}.jpg" alt="imagen Galeriathumb/">
        `;
